...
data1<-readRDS(here::here("Data/Survey Data/Main Study 1/Study1Wave1.rds"))
data2<-readRDS(here::here("Data/Survey Data/Main Study 1/Study1Wave2.rds"))
...
#Save Data
saveRDS(data1,file=here::here("Data","Survey Data","Main Study 1","study1w1full.rds")) #study 1 wave 1 full
saveRDS(data1White,file=here::here("Data","Survey Data","Main Study 1","study1w1.rds")) #study 1 wave 1 white
saveRDS(data2,file=here::here("Data","Survey Data","Main Study 1","study1w2full.rds")) #study 1 wave 2 full
saveRDS(data2White,file=here::here("Data","Survey Data","Main Study 1","study1w2.rds")) #study 1 wave 2 white
...
tau_hat <- coef(h3_model)["PraiseControl"]

# Group means and SDs
m1 <- mean(data1White$behavioralindex[data1White$PraiseControl == 1], na.rm = TRUE)
m0 <- mean(data1White$behavioralindex[data1White$PraiseControl == 0], na.rm = TRUE)

s1 <- sd(data1White$behavioralindex[data1White$PraiseControl == 1], na.rm = TRUE)
s0 <- sd(data1White$behavioralindex[data1White$PraiseControl == 0], na.rm = TRUE)

n1 <- sum(data1White$PraiseControl == 1 & !is.na(data1White$behavioralindex),na.rm = TRUE)
n0 <- sum(data1White$PraiseControl == 0 & !is.na(data1White$behavioralindex),na.rm = TRUE)
...
#N size used: 4047
#annotation info:
est <- c(ACME = mediation_norms$d.avg,#0.001414,
  ADE  = mediation_norms$z.avg,#0.029139,
  TE   = mediation_norms$tau.coef)#0.030553
pval <- c(ACME = mediation_norms$d.avg.p,
  ADE  = mediation_norms$z.avg.p,
  TE   = mediation_norms$tau.p)
lab <- paste0(formatC(est, format = "f", digits = 4),
  "\n",
  "p = ", formatC(pval, format = "f", digits = 3)
)

par(mar=c(5,6.5,3.3,01))
plot(mediation_norms, labels=c("ACME\n(Norms)",
                            "Direct Effect \n(Behavioral\n Inclusion)", "Total Effect"))
# ---- add text above each estimate ----
text( x = 0.001, y = 3, labels = lab[1], cex = 0.8) #acme
text( x = 0.03, y = 2, labels = lab[2], cex = 0.8) #ade
text( x = 0.03, y = 1, labels = lab[3], cex = 0.8) #te
# save plot to PDF: Appendix Figure D.42
pdf(here::here("Figures/si_fig42_med_norms.pdf"), width = 7, height = 5) 
...
#N size used: 4047
#annotation info:
est <- c(ACME = mediation_happy$d.avg,#0.000796,
  ADE  = mediation_happy$z.avg,#0.029757,
  TE   = mediation_happy$tau.coef)#0.030553
pval <- c(ACME = mediation_happy$d.avg.p,
  ADE  = mediation_happy$z.avg.p,
  TE   = mediation_happy$tau.p)
lab <- paste0(formatC(est, format = "f", digits = 4),
  "\n",
  "p = ", formatC(pval, format = "f", digits = 3)
)
...
pdf(here::here("Figures/si_fig43_med_happy.pdf"), width = 7, height = 5) 
par(mar=c(5,6.5,3.2,01))
plot(mediation_happy, labels=c("ACME\n(Happiness)",
                            "Direct Effect \n(Behavioral\nInclusion)", "Total Effect"))
# ---- add text above each estimate ----
...
ggsave(p,file=here::here("Figures","Fig1.pdf"),width=6,height=5)
```
...
#N size used: 4047
#annotation info:
est <- c(ACME = mediation_anxiety$d.avg,#0.01875,
  ADE  = mediation_anxiety$z.avg,#0.01180,
  TE   = mediation_anxiety$tau.coef)#0.03055
pval <- c(ACME = mediation_anxiety$d.avg.p,
  ADE  = mediation_anxiety$z.avg.p,
  TE   = mediation_anxiety$tau.p)
lab <- paste0(formatC(est, format = "f", digits = 4),
  "\n",
  "p = ", formatC(pval, format = "f", digits = 3)
)
...
plot(mediation_anxiety, labels=c("ACME\n(Anxiety)",
                            "Direct Effect \n(Behavioral\nInclusion)", "Total Effect"))
# ---- add text above each estimate ----
text( x = 0.02, y = 3, labels = lab[1], cex = 0.8) #acme
text( x = 0.01, y = 2, labels = lab[2], cex = 0.8) #ade
text( x = 0.03, y = 1, labels = lab[3], cex = 0.8) #te

# save plot to PDF: Appendix Figure D.44
pdf(here::here("Figures/si_fig44_med_anxiety.pdf"), width = 7, height = 5) 
par(mar=c(5,6.5,3.2,01))
plot(mediation_anxiety, labels=c("ACME\n(Anxiety)",
                            "Direct Effect \n(Behavioral\nInclusion)", "Total Effect"))
# ---- add text above each estimate ----
...
#N size used: 4042
#annotation info:
est <- c(ACME = mediation_anger$d.avg,#0.01176,
  ADE  = mediation_anger$z.avg,#0.01876,
  TE   = mediation_anger$tau.coef)#0.03052
pval <- c(ACME = mediation_anger$d.avg.p,
  ADE  = mediation_anger$z.avg.p,
  TE   = mediation_anger$tau.p)
lab <- paste0(formatC(est, format = "f", digits = 4),
  "\n",
  "p = ", formatC(pval, format = "f", digits = 3)
)
...
plot(mediation_anger, labels=c("ACME\n(Anger)",
                            "Direct Effect \n(Behavioral\nInclusion)", "Total Effect"))
# ---- add text above each estimate ----
text( x = 0.011, y = 3, labels = lab[1], cex = 0.8) #acme
text( x = 0.02, y = 2, labels = lab[2], cex = 0.8) #ade
text( x = 0.03, y = 1, labels = lab[3], cex = 0.8) #te
# save plot to PDF: Appendix Figure D.45
pdf(here::here("Figures/si_fig45_med_anger.pdf"), width = 7, height = 5) 
par(mar=c(5,6.5,3.2,01))
plot(mediation_anger, labels=c("ACME\n(Anger)",
                            "Direct Effect \n(Behavioral\nInclusion)", "Total Effect"))
# ---- add text above each estimate ----
...
#### Respondent Income 
Are there heterogeneous treatment effects by income?

```{r}
#H1: DV is Behavioral Empathy
check5_1<-lm(empathytask~PraiseControl*income,data=data1White_BH)
summary(check5_1)
#H2: DV is Self Reported Empathy 
check5_2<-lm(post_empathyselfindex~PraiseControl*income,data=data1White)
summary(check5_2)
#H3: Behavioral Inclusion
check5_3<-lm(behavioralindex~PraiseControl*income,data=data1White)
summary(check5_3)
#H4: DV is Attitudinal Inclusion
check5_4<-lm(post_attitudinalindex~PraiseControl*income,data=data1White)
summary(check5_4) 
#H5:DV is Long-run behavioral inclusion 
check5_5<-lm(empathytask~PraiseControl*income,data=data2White_BH)
summary(check5_5)
#H6:DV is Long-run attitudinal inclusion
check5_6<-lm(post_attitudinalindex~PraiseControl*income,data=data2White)
summary(check5_6) 
```
...
#### Respondent State 
Are there heterogeneous treatment effects by state?

```{r}

data1White_BH$state<-factor(data1White_BH$state)
data1White_BH$state <- relevel(data1White_BH$state, ref = "Pennsylvania")

#H1: DV is Behavioral Empathy
check6_1<-lm(empathytask~PraiseControl*state,data=data1White_BH)
summary(check6_1)
#H2: DV is Self Reported Empathy 
check6_2<-lm(post_empathyselfindex~PraiseControl*state,data=data1White)
summary(check6_2)
#H3: Behavioral Inclusion
check6_3<-lm(behavioralindex~PraiseControl*state,data=data1White)
summary(check6_3)
#H4: DV is Attitudinal Inclusion
check6_4<-lm(post_attitudinalindex~PraiseControl*state,data=data1White)
summary(check6_4) 
#H5:DV is Long-run behavioral inclusion 
check6_5<-lm(empathytask~PraiseControl*state,data=data2White_BH)
summary(check6_5)
#H6:DV is Long-run attitudinal inclusion
check6_6<-lm(post_attitudinalindex~PraiseControl*state,data=data2White)
summary(check6_6) 


#Extra check -- add party_id in cases where there was significant interactions

check6_2id<-lm(post_empathyselfindex~PraiseControl*state+party_id,data=data1White)
summary(check6_2id)

check6_4id<-lm(post_attitudinalindex~PraiseControl*state+party_id,data=data1White)
summary(check6_4id) 

check6_6id<-lm(post_attitudinalindex~PraiseControl*state+party_id,data=data2White)
summary(check6_6id) 
...
```{r}
data3<-readRDS(here::here("Data/Survey Data/Main Study 2","Study2.rds")) 
...
#Save Data
saveRDS(data3,file=here::here("Data","Survey Data","Main Study 2","study2full.rds")) #study 2 full
saveRDS(data3White,file=here::here("Data","Survey Data","Main Study 2","study2w.rds")) #study 2 white 
...
ggsave(p,file=here::here("Figures","Fig2.pdf"),width=6,height=5)
```
